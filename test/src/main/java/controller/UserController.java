...
public class UserController {
	...
	//private final ConcurrentHashMap<Enum, ThreadLocal> map = new ConcurrentHashMap<Enum, ThreadLocal>();
	//
	@Resource
	...
	public ModelAndView list(@RequestParam(value="page",required=false)String page,User s_user,HttpServletRequest request){
		...
		String pageCode=PageUtil.getPagation(request.getContextPath()+"/user/list.do", total, Integer.parseInt(page), 10);
