...
public class EquipmentDaoImpl implements EquipmentDao{
	...
	public int count(Equipment s_equipment) {
		...
		return (Integer) jdbcTemplate.queryForObject(sb.toString(), Integer.class);
	}
	...
	public boolean existEquipmentByTypeId(int typeId) {
		...
		int result=(Integer) jdbcTemplate.queryForObject(sql,new Object[]{typeId},Integer.class);
		if(result>0){
			return true;
		}else{
			return false;			
